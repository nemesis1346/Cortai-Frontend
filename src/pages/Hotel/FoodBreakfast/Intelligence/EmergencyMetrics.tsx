...
export default function EmergencyMetrics() {
	return (
		<Card className="bg-[color:var(--primitive-white-shadow-5)]">
			<CardHeader
				left={
			...
			<CardBody className="flex flex-col gap-2">
				{['6:00','6:30','7:00','7:30','8:00','8:30','9:00','9:30'].map((t, idx) => (
					<div key={t} className="grid grid-cols-[28px_1fr_24px] items-center gap-2">
						...
						<div className="h-2 rounded-full bg-[color:var(--primitive-white-shadow-10)] overflow-hidden">
							<div className={`h-full rounded-full ${idx === 3 ? 'bg-rose-400' : 'bg-brand'} `} style={{ width: `${[20,38,72,100,85,64,48,22][idx]}%` }} />
						</div>
