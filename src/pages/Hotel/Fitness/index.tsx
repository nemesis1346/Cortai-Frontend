	...
	return (
		<div className="flex h-full min-h-0 flex-col gap-[1.25rem] p-4 md:p-5">
			...
			<div className="flex min-h-0 flex-1 flex-col gap-[1.25rem] overflow-y-auto scrollbar-none">
				<div className="grid grid-cols-1 gap-[1.25rem] lg:grid-cols-[1.35fr_1fr] lg:items-stretch">
					<div className="flex min-h-0 w-full lg:h-full">
						<TrafficPanel />
					</div>
					<div className="flex min-h-[120px] flex-col gap-[1.25rem] lg:h-full lg:min-h-0">
				...
				<div className="grid grid-cols-1 gap-[1.25rem] lg:grid-cols-[1.35fr_1fr]">
					<EquipmentPanel />
